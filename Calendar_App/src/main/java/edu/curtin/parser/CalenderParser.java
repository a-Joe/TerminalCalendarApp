/* CalenderParser.java */
/* Generated By:JavaCC: Do not edit this line. CalenderParser.java */
...
public class CalenderParser implements CalenderParserConstants {
  ...
  final public void Event() throws ParseException {Token date, time = null, duration = null, title;
    jj_consume_token(EVENT);
    date = jj_consume_token(DATE);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case TIME:{
      time = jj_consume_token(TIME);
      duration = jj_consume_token(NUMBER);
      break;
      }
    case ALL_DAY:{
...
Event newEvent;
  ...
  final public void Plugin() throws ParseException {Token className; Token key, value; HashMap<String, String> arguments = new HashMap<>();
...
PluginInfo pluginInfo = new PluginInfo(className.image, arguments);
  ...
  public CalenderParserTokenManager token_source;
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x1040,0x1040,0x900,0x100000,};
	}

  /** Constructor with InputStream. */
  public CalenderParser(java.io.InputStream stream) {
	  this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public CalenderParser(java.io.InputStream stream, String encoding) {
	 try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
	 token_source = new CalenderParserTokenManager(jj_input_stream);
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
  ...
  /** Constructor. */
  public CalenderParser(java.io.Reader stream) {
 ...
 token_source = new CalenderParserTokenManager(jj_input_stream);
  ...
  public CalenderParser(CalenderParserTokenManager tm) {
	 token_source = tm;
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(CalenderParserTokenManager tm) {
	 token_source = tm;
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
